...
export default async function LocationsPage() {
  ...
  return (
    <>
      <div className="relative aspect-[16/6] w-full overflow-hidden border-b border-line sm:aspect-[21/6]">
        <Image
          src="/images/marketing/locations-hero.jpg"
          alt={t.locations.heroAlt}
          fill
          sizes="100vw"
